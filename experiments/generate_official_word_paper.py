...
def create_full_paper():
    ...
    add_bullet("Cloud LLM Bottlenecks and Privacy Risks: While cloud-hosted large language models provide strong reasoning, streaming plant telemetry across wide-area networks introduces latency jitter exceeding 1.5 seconds, risks shop-floor network dropouts, and conflicts with strict data governance policies protecting proprietary production logs [4].")
    ...
    add_bullet("We confirm through realistic physical fault scenarios that an INT4-quantized 1B SLM attains a 94.2% diagnostic F1-score with 142 ms response latency, delivering an effective compromise between edge compute limits and diagnostic precision.")
    ...
    add_body("Industrial vibration sensors operating at 10 to 20 kHz produce tens of thousands of sample points per second. Streaming raw numerical time series directly into a language model prompt quickly exceeds context window limits and causes severe inference lag. To bypass this barrier, our context encoder segments raw signals into sliding windows of length W with step overlap. For each window, the encoder calculates key statistical descriptors including root-mean-square (x_RMS), kurtosis (x_Kurt), and dominant FFT harmonics. When vibration crosses ISO 10816 baseline thresholds or displays characteristic bearing defect frequencies (such as BPFI), the encoder compiles a compact prompt:")
    ...
    add_back_matter("Conflicts of Interest", "The authors declare no conflicts of interest.")

    # References
    add_heading_1("References")
    references = [
        "Firouzi, F.; Farahani, B.; Weinberger, K.Q.; Chakrabarty, K. Generative IoT (GIoT): Advancing IoT With Generative AI and Large Language Models. IEEE Internet of Things Journal 2026, 13, 2105–2124.",
        "Zhou, Z.; Chen, X.; Li, E.; Zeng, L.; Shao, K.; Huang, M. Edge Intelligence: Paving the Last Mile of Artificial Intelligence With Edge Computing. Proceedings of the IEEE 2019, 107, 1738–1762.",
        ...
        "Nam, J.; Lee, D.; Park, S.; Kim, S.; Choi, J. A Survey on LLM Edge-Intelligence: Recent Advances, Deployments, and Open Challenges. IEEE Communications Surveys & Tutorials 2026, 28, 450–482.",
        ...
        "Ray, P.P.; Dash, D.; Kumar, N. LLMYOLOEdge: Multimodal Real-Time Defect Detection and Semantic Reasoning on Resource-Constrained Edge IoT. IEEE Access 2025, 13, 11200–11215.",
        ...
        "Frantar, E.; Ashkboos, S.; Hoefler, T.; Alistarh, Dan. GPTQ: Accurate Post-Training Quantization for Generative Pre-trained Transformers. In Proceedings of the International Conference on Learning Representations (ICLR); 2023.",
        ...
        "Bochem, N.; Leupers, R.; Ascheid, G. Distributed Transformer Inference with Minimized Memory Footprint on Low-Power MCU Clusters. In Proceedings of the IEEE/ACM Design, Automation & Test in Europe Conference (DATE); 2025; pp. 1–6.",
